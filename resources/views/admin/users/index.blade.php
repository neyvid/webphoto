        ...
        <table class="table table-head-fixed text-nowrap">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><span style="cursor: pointer"  onclick="changeStatus(this,{{$user->id}},'user/status/change/')" class="status badge {{ $user->status=='فعال'? "bg-success" : "bg-danger" }}">{{ $user->status }}</span></td>
              <td>
