                ...
                <div class="header-column">
                    <div class="header-row">
                        <div class="header-logo">
                            <a href="index.html">
                                <img alt="Porto" width="100" height="48" data-sticky-width="82" data-sticky-height="40" data-sticky-top="25" src={{ asset('/frontAsset/img/logo-default-slim.png') }}>
                            </a>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="header-nav-features">
                            ...
                            <div class="header-nav-feature header-nav-features-cart d-inline-flex ms-2">
                                <a href="#" class="header-nav-features-toggle">
                                    <img src={{ asset('/frontAsset/img/icons/icon-cart.svg') }} width="14" alt="" class="header-nav-top-icon-img">
                                ...
                                <div class="header-nav-features-dropdown" id="headerTopCartDropdown">
                                    <ol class="mini-products-list">
                                        <li class="item">
                                            <a href="#" title="Camera X1000" class="product-image"><img src={{ asset('/frontAsset/img/products/product-1.jpg') }} alt="Camera X1000"></a>
